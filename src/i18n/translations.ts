...
export interface TranslationStrings {
	...
	recoveryCenter: {
		...
		retryRollback: string; retryCleanup: string; confirmManual: string; rescan: string; close: string; working: string;
...
const en: TranslationStrings = {
	...
	recoveryCenter: {
		...
		retryRollback: 'Retry automatic rollback', retryCleanup: 'Retry journal cleanup', confirmManual: 'Confirm manual recovery', rescan: 'Rescan local state', close: 'Close', working: 'Checking local recovery…',
...
const zhCN: TranslationStrings = {
	...
	recoveryCenter: {
		...
		retryRollback: '重试自动回滚', retryCleanup: '重试恢复日志清理', confirmManual: '确认手动恢复', rescan: '重新扫描本地状态', close: '关闭', working: '正在检查本地恢复状态…',
