...
function delay(ms, ownerWindow) {
  return new Promise((resolve) => {
    const timerWindow = ownerWindow != null ? ownerWindow : window;
...
async function loadSubjectsForCollections(collections, client, onWarning) {
  ...
  for (const collection of collections) {
    try {
      ...
      onWarning == null ? void 0 : onWarning(`\u90E8\u5206\u6761\u76EE\u8BE6\u60C5\u83B7\u53D6\u5931\u8D25\uFF0C\u5DF2\u4F7F\u7528\u7B80\u7248\u4FE1\u606F\u7EE7\u7EED\uFF1A${collection.subject.name_cn || collection.subject.name}`);
