...
function hasLocalPropertyFieldsForCollections(collections, subjectsById, customTemplates) {
  return collections.some((collection) => {
    const subject = subjectsById.get(collection.subject_id);
    return subject !== void 0 && getTemplatePropertyGroupsForSubject(subject, customTemplates).customProperties.length > 0;
  });
}
...
var BangumiPlugin = class extends import_obsidian23.Plugin {
  ...
  openControlPanel(options) {
    ...
    this.controlPanel = new ControlPanel(
      ...
      this.episodeStatusManager,
      (_a = options == null ? void 0 : options.autoSyncStatus) != null ? _a : false
    );
