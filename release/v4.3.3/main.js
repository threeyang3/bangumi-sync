...
function extractTemplateVars(subject, collection, characters, ratingDetails, episodes, userEpisodeStatus, notePathTemplate) {
...
function generateContent(template, subject, collection, characters, ratingDetails, episodes, userEpisodeStatus, notePathTemplate) {
...
function generateContentByType(subject, collection, characters, customTemplates, ratingDetails, episodes, userEpisodeStatus, defaultPropertyValues, notePathTemplate) {
  const parsedInfo = parseInfoByType(subject.infobox, subject.type, subject.platform);
