...
var BangumiSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("\u5C01\u9762\u94FE\u63A5\u7C7B\u578B").setDesc('\u9009\u62E9\u5C01\u9762\u5C5E\u6027\u548C\u6B63\u6587\u8868\u683C\u4E2D\u4F7F\u7528\u7684\u94FE\u63A5\u7C7B\u578B\uFF08\u9700\u5F00\u542F"\u4E0B\u8F7D\u5C01\u9762\u56FE\u7247"\u624D\u80FD\u4F7F\u7528\u672C\u5730\u94FE\u63A5\uFF09').addDropdown((dropdown) => dropdown.addOption("network", "\u7F51\u7EDC\u94FE\u63A5").addOption("local", "\u672C\u5730\u94FE\u63A5").setValue(this.settings.coverLinkType || "network").onChange(async (value) => {
    ...
    new import_obsidian.Setting(containerEl).setName("\u7B14\u8BB0\u8DEF\u5F84\u6A21\u677F").setDesc("\u7B14\u8BB0\u94FE\u63A5\u7684\u57FA\u7840\u8DEF\u5F84\uFF0C\u751F\u6210\u683C\u5F0F: [[\u8DEF\u5F84/\u300A\u4E2D\u6587\u540D\u300B\u7B14\u8BB0|\u300A\u4E2D\u6587\u540D\u300B\u7B14\u8BB0]]").addText((text) => text.setPlaceholder("\u6536\u96C6\u7BB1/\u7B14\u8BB0/ACGN").setValue(this.settings.notePathTemplate).onChange(async (value) => {
    ...
    new import_obsidian.Setting(containerEl).setName("\u5B58\u50A8").addText((text) => text.setPlaceholder("\u5982\uFF1A\u672C\u5730").setValue(this.settings.defaultPropertyValues.anime_storage || "").onChange(async (value) => {
      this.settings.defaultPropertyValues.anime_storage = value || void 0;
      await this.onSave();
    }));
    new import_obsidian.Setting(containerEl).setName("\u8D44\u6E90\u5C5E\u6027").addText((text) => text.setPlaceholder("\u5982\uFF1A1080p").setValue(this.settings.defaultPropertyValues.anime_resourceAttr || "").onChange(async (value) => {
      this.settings.defaultPropertyValues.anime_resourceAttr = value || void 0;
      await this.onSave();
    }));
    new import_obsidian.Setting(containerEl).setName("\u6807\u8BED").addText((text) => text.setValue(this.settings.defaultPropertyValues.anime_slogan || "").onChange(async (value) => {
      this.settings.defaultPropertyValues.anime_slogan = value || void 0;
      await this.onSave();
    }));
    containerEl.createEl("h4", { text: "\u5C0F\u8BF4" });
    new import_obsidian.Setting(containerEl).setName("\u7248\u672C").addText((text) => text.setValue(this.settings.defaultPropertyValues.novel_version || "").onChange(async (value) => {
      this.settings.defaultPropertyValues.novel_version = value || void 0;
      await this.onSave();
    }));
    new import_obsidian.Setting(containerEl).setName("Kindle").addToggle((toggle) => toggle.setValue(this.settings.defaultPropertyValues.novel_kindle || false).onChange(async (value) => {
      this.settings.defaultPropertyValues.novel_kindle = value;
      await this.onSave();
    }));
    new import_obsidian.Setting(containerEl).setName("\u4FDD\u5B58").addToggle((toggle) => toggle.setValue(this.settings.defaultPropertyValues.novel_saved || false).onChange(async (value) => {
      this.settings.defaultPropertyValues.novel_saved = value;
      await this.onSave();
    }));
    containerEl.createEl("h4", { text: "\u6F2B\u753B" });
    new import_obsidian.Setting(containerEl).setName("\u7248\u672C").addText((text) => text.setValue(this.settings.defaultPropertyValues.comic_version || "").onChange(async (value) => {
      this.settings.defaultPropertyValues.comic_version = value || void 0;
      await this.onSave();
    }));
    new import_obsidian.Setting(containerEl).setName("\u683C\u5F0F").addText((text) => text.setValue(this.settings.defaultPropertyValues.comic_format || "").onChange(async (value) => {
      this.settings.defaultPropertyValues.comic_format = value || void 0;
      await this.onSave();
    }));
    containerEl.createEl("h4", { text: "\u6E38\u620F" });
    new import_obsidian.Setting(containerEl).setName("\u5E73\u53F0").addText((text) => text.setPlaceholder("\u5982\uFF1ASteam").setValue(this.settings.defaultPropertyValues.game_platform || "").onChange(async (value) => {
      this.settings.defaultPropertyValues.game_platform = value || void 0;
      await this.onSave();
    }));
    new import_obsidian.Setting(containerEl).setName("\u5B58\u50A8").addText((text) => text.setValue(this.settings.defaultPropertyValues.game_storage || "").onChange(async (value) => {
      this.settings.defaultPropertyValues.game_storage = value || void 0;
      await this.onSave();
    }));
  }
  /**
  ...
  addTemplateFileSetting(containerEl, templateType) {
    ...
    new import_obsidian.Setting(containerEl).setName(templateType.name).setDesc(this.getTemplateSourceDesc(config)).addDropdown((dropdown) => {
      dropdown.addOption("standard", "\u6807\u51C6\u6A21\u677F").addOption("author", "\u4F5C\u8005\u81EA\u7528\u6A21\u677F").addOption("file", "\u4ECE\u6587\u4EF6\u9009\u62E9").addOption("custom", "\u81EA\u5B9A\u4E49\u5185\u5BB9").setValue(["standard", "author", "file", "custom"].includes(config.source) ? config.source : "author").onChange(async (value) => {
...
${newCommentLines}`;
  ...
  updateTags(content, newTags) {
    ...
    const newTagsYaml = newTags.length > 0 ? `tags:
...
function extractTemplateVars(subject, collection, characters, ratingDetails, episodes, userEpisodeStatus, notePathTemplate, coverLinkType, localCoverPath) {
  ...
  const noteLink = notePathTemplate ? `[[${notePathTemplate}/\u300A${name_cn}\u300B\u7B14\u8BB0|\u300A${name_cn}\u300B\u7B14\u8BB0]]` : "";
  const vars = {
    // 基础信息
...
function generateContent(template, subject, collection, characters, ratingDetails, episodes, userEpisodeStatus, notePathTemplate, coverLinkType, localCoverPath) {
...
function generateContentByType(subject, collection, characters, customTemplates, ratingDetails, episodes, userEpisodeStatus, defaultPropertyValues, notePathTemplate, coverLinkType, localCoverPath) {
  const parsedInfo = parseInfoByType(subject.infobox, subject.type, subject.platform);
...
function applyDefaultPropertyValues(content, subjectType, category, defaultValues) {
  if (subjectType === 2) {
...
function replaceEmptyProperty(content, propertyName, defaultValue) {
...
// src/panel/tagSyncModal.ts
var import_obsidian12 = require("obsidian");
var TagSyncModal = class extends import_obsidian12.Modal {
  constructor(app, client, incrementalSync, diffs, onComplete) {
    super(app);
    this.client = client;
    this.incrementalSync = incrementalSync;
  ...
  async executeSync() {
    ...
    if (toSyncLocal.length === 0 && toSyncCloud.length === 0 && toMerge.length === 0) {
      new import_obsidian12.Notice("\u6CA1\u6709\u9009\u62E9\u8981\u540C\u6B65\u7684\u6761\u76EE");
      return;
    }
    this.statusEl.setText("\u6B63\u5728\u540C\u6B65...");
    let successCount = 0;
    ...
    this.statusEl.setText(`\u540C\u6B65\u5B8C\u6210\uFF1A\u6210\u529F ${successCount} \u4E2A\uFF0C\u5931\u8D25 ${failCount} \u4E2A`);
    if (successCount > 0) {
      new import_obsidian12.Notice(`\u6807\u7B7E\u540C\u6B65\u5B8C\u6210\uFF1A\u6210\u529F ${successCount} \u4E2A\uFF0C\u5931\u8D25 ${failCount} \u4E2A`);
      this.onComplete();
      this.close();
    } else {
      new import_obsidian12.Notice("\u540C\u6B65\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC\u8FDE\u63A5");
    }
  }
};
...
// src/panel/controlPanel.ts
var ControlPanel = class extends import_obsidian14.Modal {
  constructor(app, settings, syncManager, onFiltersChange, cachedData, onCacheUpdate) {
    super(app);
    // 分页
    this.currentPage = 1;
    this.pageSize = 50;
    ...
    this.state = {
      ...
      localSubjects: (cachedData == null ? void 0 : cachedData.localSubjects) || /* @__PURE__ */ new Map(),
  ...
  openFile(path) {
    ...
    if (file instanceof import_obsidian14.TFile) {
      ...
      new import_obsidian14.Notice("\u6587\u4EF6\u4E0D\u5B58\u5728");
    }
  }
  /**
   * 同步选中条目
  ...
  async syncSelected(overwrite = false) {
    if (this.state.selectedIds.size === 0) {
      new import_obsidian14.Notice("\u8BF7\u5148\u9009\u62E9\u8981\u540C\u6B65\u7684\u6761\u76EE");
      return;
    }
    ...
    if (selectedCollections.length === 0) {
      new import_obsidian14.Notice(overwrite ? "\u8BF7\u9009\u62E9\u8981\u540C\u6B65\u7684\u6761\u76EE" : "\u9009\u4E2D\u7684\u6761\u76EE\u90FD\u5DF2\u540C\u6B65");
      return;
    }
    this.state.loading = true;
    ...
    try {
      ...
      this.state.loading = false;
      if (result.success) {
        new import_obsidian14.Notice(`\u540C\u6B65\u5B8C\u6210\uFF01\u6210\u529F: ${result.added}, \u5931\u8D25: ${result.errors}`);
        const scanPath = this.settings.scanFolderPath || "ACGN";
        ...
        new import_obsidian14.Notice("\u540C\u6B65\u5931\u8D25");
        this.renderStatus("\u540C\u6B65\u5931\u8D25");
      }
    } catch (error) {
      this.state.loading = false;
      const errorMsg = error instanceof Error ? error.message : String(error);
      new import_obsidian14.Notice(`\u540C\u6B65\u51FA\u9519: ${errorMsg}`);
  ...
  async deleteSelected() {
    if (this.state.selectedIds.size === 0) {
      new import_obsidian14.Notice("\u8BF7\u5148\u9009\u62E9\u8981\u5220\u9664\u7684\u6761\u76EE");
      return;
    }
  ...
  openBatchEditor() {
    ...
    if (selectedCollections.length === 0) {
      new import_obsidian14.Notice("\u8BF7\u5148\u9009\u62E9\u5DF2\u540C\u6B65\u7684\u6761\u76EE\u8FDB\u884C\u7F16\u8F91");
      return;
    }
    ...
    const modal = new BatchEditorModal(
      ...
      async (operations) => {
        ...
        new import_obsidian14.Notice(`\u6279\u91CF\u7F16\u8F91\u5B8C\u6210\uFF1A\u6210\u529F ${result.success} \u4E2A\uFF0C\u5931\u8D25 ${result.failed} \u4E2A`);
        this.renderActionBar();
      }
    );
    modal.open();
  ...
  async undoLastEdit() {
    if (!this.frontmatterEditor.canUndo()) {
      new import_obsidian14.Notice("\u6CA1\u6709\u53EF\u64A4\u9500\u7684\u64CD\u4F5C");
      return;
    }
    const success = await this.frontmatterEditor.undo();
    if (success) {
      new import_obsidian14.Notice("\u64A4\u9500\u6210\u529F");
      this.renderActionBar();
    } else {
      new import_obsidian14.Notice("\u64A4\u9500\u5931\u8D25");
    }
  }
  /**
   * 同步短评
  ...
  async syncComments() {
    ...
    if (syncedCollections.length === 0) {
      new import_obsidian14.Notice("\u6CA1\u6709\u5DF2\u540C\u6B65\u7684\u6761\u76EE\uFF0C\u65E0\u6CD5\u5BF9\u6BD4\u77ED\u8BC4");
      return;
    }
    this.state.loading = true;
    ...
    try {
      ...
      this.state.loading = false;
      if (diffs.length === 0) {
        new import_obsidian14.Notice("\u6CA1\u6709\u77ED\u8BC4\u5DEE\u5F02");
      ...
      this.state.loading = false;
      const errorMsg = error instanceof Error ? error.message : String(error);
      new import_obsidian14.Notice(`\u5BF9\u6BD4\u77ED\u8BC4\u5931\u8D25: ${errorMsg}`);
  ...
  async syncTags() {
    ...
    if (syncedCollections.length === 0) {
      new import_obsidian14.Notice("\u6CA1\u6709\u5DF2\u540C\u6B65\u7684\u6761\u76EE\uFF0C\u65E0\u6CD5\u5BF9\u6BD4\u6807\u7B7E");
      return;
    }
    this.state.loading = true;
    ...
    try {
      ...
      for (const collection of syncedCollections) {
        ...
        const localSet = localTags ? new Set(localTags.map((t) => t.toLowerCase().trim())) : /* @__PURE__ */ new Set();
        const cloudSet = cloudTags ? new Set(cloudTags.map((t) => t.toLowerCase().trim())) : /* @__PURE__ */ new Set();
        const hasDiff = localSet.size !== cloudSet.size || ![...localSet].every((t) => cloudSet.has(t));
        if (hasDiff) {
          diffs.push({
            subjectId: collection.subject_id,
            name_cn: collection.subject.name_cn || "",
      ...
      this.state.loading = false;
      if (diffs.length === 0) {
        new import_obsidian14.Notice("\u6CA1\u6709\u6807\u7B7E\u5DEE\u5F02");
      ...
      this.state.loading = false;
      const errorMsg = error instanceof Error ? error.message : String(error);
      new import_obsidian14.Notice(`\u5BF9\u6BD4\u6807\u7B7E\u5931\u8D25: ${errorMsg}`);
...
var BangumiPlugin = class extends import_obsidian15.Plugin {
  constructor() {
    super(...arguments);
      ...
      case "file":
        if (config.filePath) {
          try {
            ...
            new import_obsidian15.Notice(`\u6A21\u677F\u6587\u4EF6\u8BFB\u53D6\u5931\u8D25: ${config.filePath}`);
          }
        }
        return TEMPLATE_CONFIG_MAP_AUTHOR[configKey];
      case "custom":
  ...
  openControlPanel() {
    if (!this.settings.accessToken) {
      new import_obsidian15.Notice("\u8BF7\u5148\u5728\u8BBE\u7F6E\u4E2D\u914D\u7F6E Access Token");
      return;
    }
    if (this.controlPanel) {
      this.controlPanel.close();
  ...
  async syncCollectionsWithOptions(options, showPreview = true) {
    ...
    if (options.subjectTypes.length === 0) {
      new import_obsidian15.Notice("\u8BF7\u81F3\u5C11\u9009\u62E9\u4E00\u79CD\u6761\u76EE\u7C7B\u578B");
      return;
    }
    if (options.collectionTypes.length === 0) {
      new import_obsidian15.Notice("\u8BF7\u81F3\u5C11\u9009\u62E9\u4E00\u79CD\u6536\u85CF\u72B6\u6001");
      return;
    }
    if (!this.syncManager) {
      new import_obsidian15.Notice("\u540C\u6B65\u7BA1\u7406\u5668\u672A\u521D\u59CB\u5316");
      return;
    }
    ...
    if (showPreview) {
      ...
      if (!prepareResult.success) {
        new import_obsidian15.Notice(`\u540C\u6B65\u5931\u8D25: ${prepareResult.error}`);
        this.syncModal.close();
        this.syncModal = null;
        return;
      }
      if (!prepareResult.previewItems || prepareResult.previewItems.length === 0) {
        new import_obsidian15.Notice("\u6CA1\u6709\u9700\u8981\u540C\u6B65\u7684\u6761\u76EE");
        this.syncModal.close();
        this.syncModal = null;
        return;
      }
      ...
      const previewModal = new SyncPreviewModal(
        ...
        async (result) => {
          if (result.action === "cancel") {
            new import_obsidian15.Notice("\u5DF2\u53D6\u6D88\u540C\u6B65");
            return;
          }
          this.syncModal = new SyncModal(this.app);
          this.syncModal.open();
