...
4. 升级或调整路径模板时看 [MIGRATION_GUIDE.md](./MIGRATION_GUIDE.md)
5. 需要排查同步异常时再看 [STATUS_SYNC_PITFALLS.md](./STATUS_SYNC_PITFALLS.md)
...
7. [CODE_STANDARDS.md](./CODE_STANDARDS.md)
8. [STATUS_SYNC_PITFALLS.md](./STATUS_SYNC_PITFALLS.md)
9. [REGRESSION_CHECKLIST.md](./REGRESSION_CHECKLIST.md)
