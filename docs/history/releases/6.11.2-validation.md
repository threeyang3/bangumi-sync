# 6.11.2 Release Validation

> 历史文档：本文记录 6.11.2 的 commit、测试、CI、Sandbox、Tag、Release 和分支同步事实，不是当前实现契约。可复用模板见 [`docs/maintainer/REGRESSION_CHECKLIST.md`](../../maintainer/REGRESSION_CHECKLIST.md)。

本文件记录 6.11.2 的发布门槛。6.10.x 历史项目见 [`6.10.x-validation.md`](6.10.x-validation.md)。
