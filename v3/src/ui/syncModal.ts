...
import { SyncProgressV3 } from '../sync/syncStatus';

export class SyncModalV3 extends Modal {
	private progress: SyncProgressV3;
	 ...
	 * 更新进度
	 */
	updateProgress(progress: SyncProgressV3): void {
