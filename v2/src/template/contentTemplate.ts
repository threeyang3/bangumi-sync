 ...
 * 支持用户填写的评分明细
 */
export function extractTemplateVarsV2(
	subject: Subject,
...
export function generateContentV2(
	...
	const vars = extractTemplateVarsV2(subject, collection, characters, ratingDetails);
 ...
 * 根据条目类型选择模板并生成内容
 */
export function generateContentByTypeV2(
	subject: Subject,
	collection?: UserCollection,
	characters?: CharacterInfo[],
	customTemplates?: {
