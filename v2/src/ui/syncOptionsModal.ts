...
import { SyncOptionsV2 } from '../sync/syncStatus';

/**
 * V2 同步选项
 */
export interface SyncOptionsV2Input {
 ...
 * V2 同步选项弹窗
 */
export class SyncOptionsModalV2 extends Modal {
	private options: SyncOptionsV2Input;
	private onSave: (options: SyncOptionsV2Input) => void;
	...
	constructor(
		app: App,
		defaultOptions: SyncOptionsV2Input,
		onSave: (options: SyncOptionsV2Input) => void
	) {
		super(app);
