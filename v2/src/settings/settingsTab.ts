...
import { BangumiPluginSettingsV2, TemplateConfig, TemplateSource } from './settings';
 ...
 */
export class BangumiSettingTabV2 extends PluginSettingTab {
	private settings: BangumiPluginSettingsV2;
	private onSave: () => Promise<void>;

	constructor(app: App, plugin: Plugin, settings: BangumiPluginSettingsV2, onSave: () => Promise<void>) {
		super(app, plugin);
