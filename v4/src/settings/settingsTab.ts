...
import { BangumiPluginSettingsV3, TemplateConfig, TemplateSource } from './settings';
...
export class BangumiSettingTabV3 extends PluginSettingTab {
	...
	constructor(app: App, plugin: Plugin, settings: BangumiPluginSettingsV3, onSave: () => Promise<void>) {
		super(app, plugin);
